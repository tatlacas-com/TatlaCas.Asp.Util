...
namespace TatlaCas.Asp.Core.Util.ViewModels
{
    public class DisplayFormModel : IResource
    {
        ...
        protected virtual FieldResource AddAnotherCheckbox(IResource resource, PropertyInfo property,
            FieldResource addAnotherCheckbox)
        {
            return null;
        }
    ...
    public class EditFormModel : DisplayFormModel
    {
        ...
        protected override FieldResource AddAnotherCheckbox(IResource resource, PropertyInfo property,
            FieldResource addAnotherCheckbox)
        {
            if (resource.ShowAddAnotherAfterSave && property.Name == nameof(resource.AddAnotherAfterSave))
            {
                ...
                addAnotherCheckbox = new FieldResource
                {
